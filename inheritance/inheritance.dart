void main(List<String> args) {
  ...
  print(adm.getLangs());
  print(adm.getSocial());
  print(adm.getTransactions());
  print(adm.getUsers());
  print(adm.getLangsWithoutGe);
  print(adm.hi());
  print("********");

  SuperAdmin supAdm = SuperAdmin();
  print(supAdm.getLangs());
  print(supAdm.getSocial());
  print(supAdm.getTransactions());
  print(supAdm.getUsers());
  print(supAdm.getPayments());
  print(supAdm.getLangsWithoutGe);
  print(supAdm.hi());
}
